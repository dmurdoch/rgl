...
//    Vertex Av = normal.getRecycled(elem);
    ...
    rglwidgetClass.prototype.drawBackground = function(id, subsceneid, context) {
      var gl = this.gl || this.initGL(),
          obj = this.getObj(id),
          subscene,
          bg, i, savepr, saveinvpr, savemv, savenorm, m, bbox;
      ...
      if (typeof obj.quad !== "undefined") {
        ...
        // console.log("saved=");
        // rglwidgetClass.logMatrix(savemv);
        ...
        m = new CanvasMatrix4();
        m.rotate(90, 1, 0, 0);
        // console.log("just rotation");
        // rglwidgetClass.logMatrix(m);
        m.scale(2.0*maxaspect*ranges[0]/aspect[0], 
                2.0*maxaspect*ranges[1]/aspect[1],
                2.0*maxaspect*ranges[2]/aspect[2]);
        // console.log("with scaling");
        // rglwidgetClass.logMatrix(m);
        m.translate(center[0], center[1], center[2]);
        // console.log("before multiplying");
        // rglwidgetClass.logMatrix(m);
        m.multRight(savemv);
