...
public:
  ...
  void useColor() const;
  float data[4];
  friend Color operator * (const Color& a, const float d)
  { return Color(a.data[0]*d,a.data[1]*d,a.data[2]*d,a.data[3]*d); }
  friend Color operator + (const Color& a, const Color& b)
  { return Color(a.data[0]+b.data[0],a.data[1]+b.data[1],a.data[2]+b.data[2],a.data[3]+b.data[3]); }
  friend Color operator * (const float d, const Color& a)
  { return Color(a.data[0]*d,a.data[1]*d,a.data[2]*d,a.data[3]*d); }
  bool operator==(const Color &c) const
  {
   return data[0]==c.data[0] && data[1]==c.data[1] && data[2]==c.data[2] && data[3]==c.data[3];
  }
  bool operator!=(const Color &c) const
  {
   return !(data[0]==c.data[0] && data[1]==c.data[1] && data[2]==c.data[2] && data[3]==c.data[3]);
