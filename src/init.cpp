...
#undef CHECK_ARGS
 ...
 static const R_CMethodDef CEntries[] = { 
   ...
   {"rgl_texts",		(DL_FUNC) &rgl_texts, 13, aIIDSDISIDSIII},
 ...
 static const R_CallMethodDef CallEntries[]  = {
   ...
   FUNDEF(rgl_textures_from_list, 2),
   FUNDEF(rgl_textureRaster, 2),
   FUNDEF(rgl_set_user_data, 2),
   FUNDEF(rgl_get_user_data, 2),
   FUNDEF(rgl_build_atlasR, 7),
   FUNDEF(rgl_get_textures, 1),
