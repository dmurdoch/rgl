...
#undef CHECK_ARGS
 ...
 static const R_CMethodDef CEntries[] = { 
   ...
   {"rgl_newsubscene",		(DL_FUNC) &rgl_newsubscene, 2, aII},
   {"rgl_setsubsceneid",	(DL_FUNC) &rgl_setsubsceneid, 2, aII},
   ...
   {"rgl_getEmbedding",         (DL_FUNC) &rgl_getEmbedding, 2, aII},
   {"rgl_addtosubscene", 	(DL_FUND) &rgl_addtosubscene, 3, aIII},
 ...
 static const R_CMethodDef CEntries[] = { 
   ...
   FUNDEF(rgl_newsubscene, 2),
   FUNDEF(rgl_setsubsceneid, 2),
