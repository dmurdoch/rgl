...
`r indexprop(c("addToSubscene", "delFromSubscene"))`

These two methods each take two arguments:  `id` and `subscene`,
which should be the `rgl` ids of an object and a subscene to 
add it to or delete it from.
