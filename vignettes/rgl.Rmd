...
```{r eval=requireNamespace("orientlib", quietly = TRUE) && requireNamespace("lattice", quietly = TRUE), fig.alt=c("lattice display of volcano", "base graphics display of volcano")}
