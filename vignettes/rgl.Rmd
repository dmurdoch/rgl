...
By default when you open a new plot:
...
* `theta` sets the rotation around the z axis, in degrees. 
* `phi` sets the "vertical" rotation around the x axis, from -90 to 90
  degrees.
  
The default angle is roughly `theta = 0, phi = -60`. Starting from
this position:
