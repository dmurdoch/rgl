...
deprecated
functions 
`r deprecated(c("rgl.primitive", "rgl.points",
"rgl.linestrips", "rgl.lines", "rgl.triangles",
"rgl.quads", "rgl.abclines", "rgl.planes", "rgl.clipplanes",
"rgl.spheres", "rgl.sprites"))`
and other functions soon to be deprecated: `r indexfns(c("rgl.texts", "rgl.bg",
"rgl.bbox", "rgl.surface"))`.  
...
`r indexfns(c("ids3d", "rgl.ids"))`:              | ids, types and tags of current objects
`r indexfns("tagged3d")`:                         | find tags or objects with tags

There are deprecated versions of the functions above:
`r deprecated(c("rgl.cur", "rgl.set"))`.  These should not be called.
