...
- fine tune the sizing:  text looks a little too large now.
- handle colored emojis
- switch to using the Cairo package instead of using
the Pango/Cairo libs.
- add functions to display the atlas for debugging, decide about function interfaces (e.g. build_atlasC).
