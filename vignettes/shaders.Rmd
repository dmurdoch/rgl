...
- Somehow the front vs back distinction is different
in the WebGL display vs the R display (e.g. back = "lines" works in WebGL, but makes the front get lines in R)