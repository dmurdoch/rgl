...
material properties in a call, and for some, `...` will
...
rgl.par3d.readonly
```
which give the same information for `par3d`.  Currently
these are planned for release in `rgl` version 1.0.0,
the release that deprecated `rgl.*`, but they may 
appear sooner than that.
