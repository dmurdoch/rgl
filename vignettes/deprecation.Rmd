...
On the other hand, `material3d(color = "black")` will set
...
programming, such as `rgl.attrib()` and `rgl.user2window()`,
and a few legacy functions like `rgl.Sweave()` supporting
